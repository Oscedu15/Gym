...
const trainerData = [
  {
    ...
    description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde, modi eius dolorum impedit quam similique.' ,
    social: [
  ...
  return (
    <section className="py-12 xl:h-[110vh]" id="team">
      <div className="container mx-auto h-full flex flex-col items-center justify-center">
        ...
        initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.2}} className="h2 text-center mb-6">Our Trainer</motion.h2>
        {/* trainers grid */}
        <motion.div variants={fadeIn('up', 0.6)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.2}} className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-12 mb-12">
          ...
          return <div key={index} className="flex flex-col items-center text-center">
            ...
            {/* name */}
            <h4 className="h-4 mb-2">{trainer.name}</h4>
            {/* role */}
        ...
        <motion.div variants={fadeIn('up', 0.6)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.2}} >
          <CustomButton text="See all trainers"
