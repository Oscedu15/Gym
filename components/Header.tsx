...
const Header = () => {
  ...
  return (
    <header
      ...
      } fixed max-w-[1920px] z-50 top-0 w-full bg-primary-200 h-[100px] transition-all`}
    >
      <div className="container mx-auto h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-white flex items-center gap-4">
            <button className="capitalize hover:text-accent transition-all font-medium text-base">
              login
            </button>
            <button className="capitalize hover:text-accent transition-all font-medium text-base">
              register
